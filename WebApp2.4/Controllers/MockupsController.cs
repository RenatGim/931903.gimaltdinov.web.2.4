...
namespace app.Controllers
{
    public class MockupsController : Controller
    {
        ...
        [HttpPost]
        public IActionResult SignUp(AuthViewModel a)
        {
        ...
        [HttpPost]
        public IActionResult SignUp2(AuthViewModel a)
        {
        ...
        [HttpPost]
        public IActionResult Reset2(AuthViewModel a, string myTextbox)
        {
        ...
        [HttpPost]
        public IActionResult Reset3(AuthViewModel a)
        {
