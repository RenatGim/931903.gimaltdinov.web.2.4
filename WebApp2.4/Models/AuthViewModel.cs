...
namespace app.Models
{
    ...
    public class IdentityMap
    {
        ...
        private  Dictionary<string, AuthViewModel> accounts = new Dictionary<string, AuthViewModel>();
        private IdentityMap() { }
        ...
        public static void AddAction(AuthViewModel account, string email)
        {
            Instance.accounts.Add(email, account);
        }
        public static Dictionary<string, AuthViewModel> Get()
        {
